...
namespace Handlers
{
    ...
    {
        private BlockingCollection<RecylingHandler> pool = new BlockingCollection<RecylingHandler>();
    ...
    public class RecylingHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            context.Response.Write(string.Format("Total requests: {0}, HandlerID: {1}, Handler Requests {2}", factory.TotalRequests, handlerID, RequestCount));
        }
